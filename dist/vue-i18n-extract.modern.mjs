...
function resolveConfig() {
  ...
  options.exclude = [...(Array.isArray(options.exclude) ? options.exclude : [options.exclude]).filter(excluded => excluded !== undefined), ...(options.excludedKeys || [])];
  return options;
}
...
function unquotePropertiesFromJSONString(stringifiedObject) {
